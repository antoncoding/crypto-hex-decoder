...
console.log("second TIME STRAIGH RLP tx.raw DECODED : "+JSON.stringify(ethDecodedRawTx));
...
console.log("second TIME STRAIGH RLP tx.raw DECODED : "+JSON.stringify(btcDecodedRawTx));
